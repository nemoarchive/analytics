        ...
        if filetype == "tar" or filetype == "gz":
            if filepath is None:
                ...
                if tartype == 'mex':
                    ...
                    import mexuploader as mexuploader
                    return mexuploader.MexUploader()
                elif tartype == 'threetab':
                    #import gear.threetabuploader as threetabuploader
                    import threetabuploader as threetabuploader
                    return threetabuploader.ThreeTabUploader()
        if filetype == "h5ad":
            # from gear.h5aduploader as h5aduploader
            return h5aduploader.H5adUploader()
        if filetype == "hdf5":
            # from gear.h510xuploader as h510xuploader
            return h510xuploader.H510xUploader()
